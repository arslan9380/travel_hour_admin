...
class _UpdatePlaceState extends State<UpdatePlace> {
  ...
  var whatsappNumberCtrl = TextEditingController();
  ...
  initData() {
    ...
    whatsappNumberCtrl.text = widget.placeData.whatsAppNumber ?? "";
    phoneNumberCtrl.text = widget.placeData.phoneNumber ?? "";
    getGuideData();
  }
                ...
                Row(
                  children: <Widget>[
                    ...
                    Expanded(
                      child: TextFormField(
                        decoration: inputDecoration(
                            'Enter WhatsApp', 'WhatsApp', whatsappNumberCtrl),
                        keyboardType: TextInputType.phone,
